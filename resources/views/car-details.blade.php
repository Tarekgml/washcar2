...
@php
  $product = App\Models\Car::find($id);
@endphp
<head>
...
function closeFullscreen() {
  ...
  <span class="option">الحجم</span>
    ...
    <div style="display: flex; justify-content: space-between; gap: 10px;">
      <a href="{{ $product->link }}" class="add-to-cart" style="flex: 1; text-align: center;" id="showMessageBtn"> تأجير السيارة </a>
    </div>
  </div>
  <!-- message -->
  <div id="overlay">
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.11.3/js/lightbox.min.js"></script>
    ...
    <script>
        function redirect() {
            Swal.fire({
                title: 'هل تريد تأكيد طلب الإيجار',
                icon: 'info',
                ...
                cancelButtonText: 'لا'
                  ...
                  if (result.isConfirmed) {
                    ...
                    form.method = 'post';
                    form.action = '/carRental/' + {{ $product->id }};
