@if(auth()->user()->status_website != 'under_revision')
<script>
...
<head>
    ...
    <title> حسابكم قيد المراجعة</title>
    <link rel="stylesheet" href="../includes/css/style.css" media="screen">
    <link rel="stylesheet" href="../includes/Corporate-Account/css/orders-home.css" media="screen">
...
<body class="u-body u-xl-mode" data-lang="en">
    ...
    <center>
        ...
        <h3 style="font-family: Almarai; text-align: center;">حسابك قيد المراجعة</h3>


        <h5 style="font-family: Almarai; text-align: center;">في انتظار رد الادارة </h5>
<br><br>
        <button class="button">
