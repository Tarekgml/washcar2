...
<body class="u-body u-xl-mode" data-lang="en">
   ...
   @include('includes.fixedbar')
    <center>
        ...
        <dotlottie-player src="https://lottie.host/ba756e3c-8345-4d53-b7b9-a265d48128a9/4KQDQgKVXy.json" background="transparent" speed="1" style="width: 200px; height: 200px;" loop autoplay></dotlottie-player>

        <h4 style="font-family: Rubik;"> <mark>من نحن </mark></h4>

    </center>
    <h6 style="font-family: Rubik; font-size:16px; direction:rtl; margin:15px;">


        {{  \App\Models\Website::first()->about_us }}
    ...
    <script>
        ...
        document.getElementById('toggle-sidebar').addEventListener('click', function() {
            ...
            document.getElementById('overlayside').classList.toggle('active');
        });

        document.getElementById('overlayside').addEventListener('click', function() {
            document.getElementById('sidebar').classList.remove('active');
            document.getElementById('overlayside').classList.remove('active');
        });
    </script>
</body>
