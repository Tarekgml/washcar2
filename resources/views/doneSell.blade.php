...
<body class="u-body u-xl-mode" data-lang="en">
  ...
  <section class="u-clearfix u-section-1" id="sec-dc61">
    <div class="u-clearfix u-sheet u-sheet-1">
      ...
      <h6 class="u-align-center u-custom-font u-text u-text-2">{{ \App\Models\SellCarOrder::find($id)->uuid }}</h6>
        <h6 class="u-align-center u-custom-font u-text u-text-2">{{ \App\Models\SellCar::find(\App\Models\SellCarOrder::find($id)->car_id)->link }}</h6>
